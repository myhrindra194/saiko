...
const Banner = () => {
  return (
    <div className="w-full h-full animate-once animate-duration-1000 animate-ease-linear animate-normal animate-fill-forwards md:px-20 px-8 ">
      ...
      <div className="w-full h-auto md:flex justify-between items-center">
        <div className="md:w-50 mb-10 text-center md:text-start animate-fade-right">
          <h3 className="md:text-2xl text-lg mb-10">
        ...
        <div className="flex justify-center flex-1 items-center">
          <img src={ai} alt="robot" className="animate-fade-up w-full h-full max-w-2xl object-contain"/>
        </div>
