        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="py-1 px-2.5 border border-gray-200 dark:border-gray-200/20 rounded-full">
              <div className="h-3 w-16 bg-gray-300 dark:bg-slate-700 rounded"></div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="h-3 bg-gray-300 dark:bg-slate-700 rounded w-4/6"></div>
            <div className="h-3 bg-gray-300 dark:bg-slate-700 rounded w-3/6"></div>
          </div>

          {/* Author and date placeholders */}
          <div className="flex space-x-2">
            <div className="h-3 bg-gray-300 dark:bg-slate-700 rounded w-1/4"></div>
            <div className="h-3 bg-gray-300 dark:bg-slate-700 rounded w-1/5"></div>
          </div>
        </div>
      </div>
    </div>
